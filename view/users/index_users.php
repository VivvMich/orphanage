    ...
    <tbody>
        ...
        if(isset($_GET["page"])){
            ...
            foreach($children as $child){
                ...
                $table .= "<td><a class='destroy-child' data-toggle='tooltip' data-placement='top' title='Supprimer un gosse'  href='controller/delete_ctrl_children.php?id=$child[id_child]&page=$p'>💣</a><a class='destroy-child' data-toggle='tooltip' data-placement='top' title='Modifier un gosse' href='view/children/update_children.php?id=$child[id_child]&page=$p'>🧬</a></td>";
                $table .= "</tr>";
            }
            echo $table;
        }
